			...
			<div class="col-xs-12 col-md-5 col-lg-5">
				...
				@include('errors.note')
						<form method = "post">
							...
							<div class="form-group">
    							<input type="submit" name="submit" class="form-control" placeholder="Tên danh mục..." value = "Thêm mới">
							</div>
							{{csrf_field()}}
							</form>
						</div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
				        ...
				        <tbody>
			                  ...
			                  <a href="{{asset('admin/category/delete/'.$cate->cate_id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger"><span 
