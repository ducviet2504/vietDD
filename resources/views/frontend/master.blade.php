...
<head>
	...
	<link rel="stylesheet" href="css/bootstrapFrontend/bootstrap.min.css">
	<link rel="stylesheet" href="css/bootstrapFrontend/home.css">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-6 col-sm-6 col-md-9">
					...
					<form menthod="get" action="{{asset('search/')}}">
